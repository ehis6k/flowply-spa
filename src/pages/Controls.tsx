  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {/* Escalations */}
        <section id="escalations" className="py-24 bg-background">
          <div className="container mx-auto px-4">
            <SectionHeader 
              title="Escalation Paths"
              subtitle="Tiered response paths for every situation"
            />
                ...
                {[
                  {
                    ...
                    description: "Self-healing automations handle routine issues instantly.",
                    items: ["Auto-retry logic", "Circuit breakers", "Fallback workflows"]
                  },
                  {
                    level: "L2",
                    title: "Ops Team Review",
                    description: "Our operations team handles issues requiring human judgment.",
                    items: ["15-minute response SLA", "Context-aware triage", "Runbook execution"]
                  },
                  {
                    level: "L3",
                    title: "Customer Escalation",
                    description: "Critical issues requiring customer decision are escalated promptly.",
                    items: ["Direct communication", "Decision documentation", "Post-incident review"]
                  }
                ].map((tier, index) => (
                  <motion.div
                    key={tier.level}
                    ...
                    className="bg-card rounded-2xl p-6 border border-border"
                  >
                    <div className="w-10 h-10 rounded-lg bg-accent text-accent-foreground flex items-center justify-center mb-4 font-bold">
                      {tier.level}
                    </div>
        ...
        {/* Human-in-the-Loop */}
        <section id="hitl" className="py-24 bg-muted/30">
          <div className="container mx-auto px-4">
            <SectionHeader 
        ...
        {/* Audit & Compliance */}
        <section id="audit-compliance" className="py-24 bg-background">
          <div className="container mx-auto px-4">
            <SectionHeader 
